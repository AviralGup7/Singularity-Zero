...
_INDICATOR_ENGINE_RULES: tuple[tuple[str, str, int, str], ...] = (
    ...
    (
        ...
        "injectionengine",
        75,
        "DOM XSS — needs headless browser, fallback to static sink replay.",
    ),
    (
        "open_redirect",
        "injectionengine",
        70,
        "Open redirect — replay to confirm cross-host navigation.",
    ),
    ...
    (
        ...
        "injectionengine",
        75,
        "SQL error leakage — replay to confirm blind or error-based.",
    ),
    ...
    (
        ...
        "injectionengine",
        95,
        "Command injection — replay with safe command payload.",
    ),
    ...
    (
        ...
        "sstiexploitationengine",
        90,
        "SSTI — replay with safe template expression.",
    ),
    (
        "path_traversal",
        "pathtraversalexploitationengine",
        90,
        "Path traversal — replay with safe file probe.",
    ),
    ...
    (
        ...
        "pathtraversalexploitationengine",
        85,
        "LFI — replay with safe file probe.",
    ),
    (
        "file_upload",
        "fileuploadexploitationengine",
        80,
        "File upload — replay with safe polyglot probe.",
    ),
    (
        "upload",
        "fileuploadexploitationengine",
    ...
    (
        ...
        "deserializationexploitationengine",
        90,
        "Deserialization — replay with safe gadget.",
    ),
    (
        "prototype_pollution",
        "prototypepollutionengine",
        80,
        "Prototype pollution — replay with safe __proto__ probe.",
    ),
    ...
    (
        ...
        "raceconditionengine",
        50,
        "Rate limit — concurrent burst replay (low priority).",
    ),
    ...
    (
        ...
        "webcachepoisonengine",
        80,
        "Cache poisoning — replay with unkeyed header.",
    ),
    (
        "web_cache_poisoning",
        "webcachepoisonengine",
    ...
    (
        ...
        "subdomaintakeoverengine",
        90,
        "Subdomain takeover — confirm dangling record.",
    ),
    ...
    (
        ...
        "headerinjectionengine",
        90,
        "Header injection — replay with WAF bypass payload.",
    ),
    (
        "waf_bypass",
        "headerinjectionengine",
        90,
        "WAF bypass candidate — replay with smuggling/H2 probe.",
    ),
    ...
    (
        ...
        "deserializationexploitationengine",
        80,
        "XXE — replay with safe external entity probe.",
    ),
    ...
    return {
        ...
        "by_engine": {
            engine: {
                ...
                "confirmed": sum(1 for f in items if f.exploitability == Exploitability.CONFIRMED),
            }
