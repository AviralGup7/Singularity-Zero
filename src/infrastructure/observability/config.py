    ...
    def from_env(cls) -> ObservabilityConfig:
        ...
        config = cls(
            ...
            metrics=MetricsConfig(
                ...
                prometheus_port=int(
                    os.getenv("OBSERVABILITY_METRICS_PORT", os.getenv("PROMETHEUS_PORT", "9090"))
                ),
                prometheus_host=os.getenv(
                    "PROMETHEUS_HOST",
                    os.getenv("OBSERVABILITY_METRICS_HOST", "127.0.0.1"),
                ),
                prometheus_require_mtls=(
                    os.getenv(
                        "PROMETHEUS_REQUIRE_MTLS",
                        os.getenv("OBSERVABILITY_METRICS_MTLS", "false"),
                    ).lower()
                    == "true"
                ),
