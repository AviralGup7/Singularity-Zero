    ...
    try:
        ...
        if finding:
            try:
                ...
                logger.warning("Operation failed in services.py", exc_info=True)
...
async def probe_cloud_run(
    ...
    from .helpers import _build_cloud_run_1st_gen_candidates, _build_cloud_run_2nd_gen_candidates
