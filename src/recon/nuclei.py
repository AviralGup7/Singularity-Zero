...
_PARAM_CATEGORY_HINTS: dict[str, ParamCategory] = {
    # SSRF candidates
    "url": ParamCategory.SSRF,
    "uri": ParamCategory.SSRF,
    "dest": ParamCategory.SSRF,
    "destination": ParamCategory.SSRF,
    "redirect": ParamCategory.REDIRECT,
    "redirect_uri": ParamCategory.REDIRECT,
    "redirect_url": ParamCategory.REDIRECT,
    "next": ParamCategory.REDIRECT,
    "return": ParamCategory.REDIRECT,
    "return_to": ParamCategory.REDIRECT,
    "returnto": ParamCategory.REDIRECT,
    "callback": ParamCategory.REDIRECT,
    "continue": ParamCategory.REDIRECT,
    "image_url": ParamCategory.SSRF,
    "image": ParamCategory.SSRF,
    "feed": ParamCategory.SSRF,
    "feed_url": ParamCategory.SSRF,
    "host": ParamCategory.SSRF,
    "domain": ParamCategory.SSRF,
    "site": ParamCategory.SSRF,
    "view": ParamCategory.SSRF,
    "path": ParamCategory.SSRF,
    # Open redirect candidates
    "out": ParamCategory.REDIRECT,
    "to": ParamCategory.REDIRECT,
    "from": ParamCategory.REDIRECT,
    "forward": ParamCategory.REDIRECT,
    # LFI / path-traversal candidates
    "file": ParamCategory.LFI,
    "filename": ParamCategory.LFI,
    "filepath": ParamCategory.LFI,
    "folder": ParamCategory.LFI,
    "root": ParamCategory.LFI,
    "pg": ParamCategory.LFI,
    "style": ParamCategory.LFI,
    "template": ParamCategory.LFI,
    "php_path": ParamCategory.LFI,
    "doc": ParamCategory.LFI,
    "document": ParamCategory.LFI,
    "download": ParamCategory.LFI,
    "include": "lfi",
    "dir": "lfi",
    "page": "lfi",
    "pdf": "lfi",
