...
in ``src.recon.live_hosts``.  Caller-visible behaviour is unchanged.
"""
...
def _emitter(progress_callback: Any = None) -> Any:
    return emit_collection_progress
