...
ACTIVE_PLUGIN_SPECS: tuple[AnalysisPluginSpec, ...] = (
    ...
    spec(
        ...
        "Response Secrets Scanner",
        "Scan response headers and bodies for hardcoded keys, tokens, and private material. Off by default.",
        "exposure",
        enabled_by_default=False,
    ),
    spec(
        "passive_mass_assignment_detector",
        "Passive Mass Assignment Surface",
        "Flag JSON mutation endpoints and privileged field names without sending extra traffic. Off by default.",
        "exposure",
        enabled_by_default=False,
    ),
    spec(
        "csp_bypass_probe",
        "CSP Bypass Heuristics",
        "Parse Content-Security-Policy headers for unsafe-inline, weak nonces, and permissive base-uri. Off by default.",
        "active",
        enabled_by_default=False,
    ),
    spec(
        ...
        "Score discovered API endpoints for missing auth, verb exposure, and schema gaps. Off by default.",
        "api",
        enabled_by_default=False,
    ),
    spec(
        "differential_logic_prober",
        "Differential Logic Prober",
        "Compare responses across contexts for IDOR and authorization drift. Off by default.",
        "logic",
        enabled_by_default=False,
    ),
    spec(
        ...
        "Collapse near-duplicate findings with vector similarity. Off by default.",
        "intelligence",
        enabled_by_default=False,
    ),
    spec(
        ...
        "Optional GraphQL alias-batching and persisted-query probes. Off by default.",
        "active",
        enabled_by_default=False,
    ),
)
