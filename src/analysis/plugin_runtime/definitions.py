"""Lazy-loaded analyzer binding definitions.

Each entry maps a binding name to ``(module_path, attr_name, input_kind)``
tuples. The actual function objects are resolved lazily at first access to
avoid loading all analyzer modules at startup.
"""
