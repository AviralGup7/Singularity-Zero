...
def _register_bindings() -> None:
    ...
    inline_bindings = {
        ...
        "rate_limit_bypass_detector": _binding(
            "ranked_items_and_cache", limit_key="rate_limit_probe_limit", default_limit=10
        ),
        "http_smuggling_detector": _binding(
            "ranked_items_and_cache", limit_key="smuggling_probe_limit", default_limit=8
        ),
        ...
        "cognitive_flow_analysis": _binding(
            "urls_and_cache", limit_key="cognitive_flow_limit", default_limit=12
        ),
        ...
        "graphql_introspection_check": _binding(
            "priority_urls_and_cache", limit_key="graphql_introspection_limit", default_limit=10
        ),
        "http_smuggling_probe": _binding(
            "priority_urls_and_cache", limit_key="smuggling_probe_limit", default_limit=10
        ),
        "http2_probe": _binding(
            "priority_urls_and_cache", limit_key="http2_probe_limit", default_limit=8
        ),
        "oauth_flow_analyzer": _binding(
            "priority_urls_and_cache", limit_key="oauth_probe_limit", default_limit=10
        ),
        "websocket_message_probe": _binding(
            "priority_urls_and_cache", limit_key="websocket_probe_limit", default_limit=8
        ),
        ...
        "clickjacking_test": _binding(
            "priority_urls_and_cache", limit_key="clickjacking_limit", default_limit=20
        ),
        ...
        "mass_assignment_detector": _binding(
            "priority_urls_and_cache", limit_key="mass_assignment_limit", default_limit=10
        ),
        "cache_deception_probe": _binding(
            "priority_urls_and_cache", limit_key="cache_deception_limit", default_limit=12
        ),
        "deserialization_language_probe": _binding(
            "priority_urls_and_cache", limit_key="deserialization_lang_limit", default_limit=8
        ),
        "tenant_isolation_check": _binding(
            "priority_urls_and_cache", limit_key="tenant_isolation_limit", default_limit=10
        ),
    }
