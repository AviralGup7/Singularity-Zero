...
def _prune_launcher_dirs(
    launcher_root: Path, keep_launcher_runs: int
            ...
            try:
                ...
                if conn is not None:
                    try:
                        ...
                        logger.warning(
                            "Operation failed in maintenance.py: %s", close_exc, exc_info=True
                        )  # noqa: BLE001
                import sqlite3
                ...
                if self.lockfile_path.exists():
                    try:
                        ...
                        logger.warning(
                            "Operation failed in maintenance.py: %s", lock_exc, exc_info=True
                        )  # noqa: BLE001
