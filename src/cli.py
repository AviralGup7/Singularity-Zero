...
def _build_parser() -> argparse.ArgumentParser:
    ...
    # ──────────────────────────────────────────────────────────
    # PLUGIN AREA (Governance & Scaffolding)
    # ──────────────────────────────────────────────────────────
...
def handle_plugin_new(args: argparse.Namespace) -> int:
    ...
    if category == "recon":
        ...
        # Scaffolding content with fixed path import
...
from src.recon.common import BaseReconSource  # Correct absolute import path!

class {name.capitalize()}Source(BaseReconSource):
    """Custom {name} recon plugin source."""
    ...
    def run(self, target: str) -> list[str]:
        """Execute recon operations for custom source."""
