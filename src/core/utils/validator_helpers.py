"""Validator utility builders and JSON helpers for the core layer.

Provides standardized result building, manual hint generation, JSON type
helpers, header normalization, and object family classification. Used by
both analysis and execution packages without cross-layer dependencies.
"""
