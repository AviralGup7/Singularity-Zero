"""Response delta classification rules for the core layer.

Contains the core classification logic for determining the significance
of response changes between baseline and mutated requests. Used by both
analysis and execution packages without cross-layer dependencies.
"""
