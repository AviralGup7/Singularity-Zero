...
| `GRAPHGEN_STRICT` | boolean | `true` | Fail-closed when stored declared GraphGenID *or* post-prune capability fingerprint differs. Empty stored ids (pre-MVR checkpoints) skip. |
