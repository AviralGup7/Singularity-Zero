...
**Invariant dependency / proof graph** (`src/core/frontier/invariant_graph.py`): I22 → I30 → (I33, I28) → I31 → I32 → I34 → I35 → I36 → I37, with I37 also depending on I30. Each node names prerequisites, protected state, constrained transitions, crash/concurrency windows, recovery rule, and proving tests. I35 `VERIFY_INVARIANTS` fail-closes if recovered tickets/settlements/identities violate I30/I31/I32/I33. Satisfying the I35 phase machine is not enough.
