...
| **Formal Invariants Verification** | `src/core/frontier/invariant_checker.py`, `tests/unit/test_formal_invariants.py` | Automated invariant audit suite evaluating I1–I29 (see architecture.md §6). |
