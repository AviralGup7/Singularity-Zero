...
| **Formal Invariants Verification** | `src/core/frontier/invariant_checker.py`, `src/core/frontier/causal_identity.py`, `src/core/frontier/failure_model.py`, `src/core/frontier/recovery_protocol.py`, `tests/unit/test_formal_invariants.py` | Automated invariant audit suite evaluating I1–I29 plus cross-subsystem I30–I35 (see architecture.md §6). I35 is the recovery state machine for every durable boundary. |
