    ...
    <>
          ...
          {link.isFlowing && (
            <>
              <motion.path d={link.d} className="stage-theater-edge stage-theater-edge--active"
                stroke={link.hasFailure ? 'var(--bad)' : 'var(--accent)'}
              ...
              <g className="stage-theater-edge-particles">
                <circle r={2.8} className="stage-theater-edge-particle"
                  fill={link.hasFailure ? 'var(--bad)' : 'var(--accent)'}>
                ...
                <circle r={2.1} className="stage-theater-edge-particle stage-theater-edge-particle--secondary"
                  fill={link.hasFailure ? 'color-mix(in srgb, var(--bad) 75%, transparent)' : 'color-mix(in srgb, var(--accent) 75%, transparent)'}>
      ...
      <defs>
        ...
        <linearGradient id="stageTheaterFailure" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="var(--bad)" stopOpacity="0.25" />
          <stop offset="50%" stopColor="var(--bad)" stopOpacity="0.95" />
          <stop offset="100%" stopColor="var(--bad)" stopOpacity="0.25" />
        </linearGradient>
      </defs>
    </>
  );
