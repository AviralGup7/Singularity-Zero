    ...
    for i, line in enumerate(lines, 1):
        ...
        for m in matches:
            ...
            if rel_path_md == "architecture.md":
                if anchor in (
                    "1-multi-tenant-key-namespacing-playbook--pubsub-isolation",
            ...
            if rel_path_md == "testing.md":
                if anchor in (
                    "145-automated-quality-gates--pipeline-security-verification",
                    "-automated-quality-gates--pipeline-security-verification",
                ):
                    broken = True
                    reason = "wrong anchor slug"
