...
FINDINGS_ESTIMATE = {
    ...
    "ssrf_active_probe": 2.3,
    "ssrf_oob_validator": 1.8,
    "proxy_ssrf_probe": 1.5,
    "sqli_safe_probe": 2.1,
    "command_injection_active_probe": 1.9,
    "ssti_active_probe": 1.7,
    "nosql_injection_probe": 1.4,
    "path_traversal_active_probe": 2.0,
    "xxe_active_probe": 1.6,
    "open_redirect_active_probe": 2.2,
    "crlf_injection_probe": 1.8,
    "host_header_injection_probe": 1.5,
    "xpath_injection_active_probe": 1.2,
    "jwt_manipulation_probe": 2.4,
    "deserialization_probe": 1.1,
    "csrf_active_probe": 2.0,
    "hpp_active_probe": 1.3,
    "websocket_hijacking_probe": 0.9,
    "cookie_manipulation_probe": 1.4,
    "param_mining_probe": 2.5,
    # Auth bypass
    "auth_bypass_check": 3.1,
    "access_control_analyzer": 2.8,
    "jwt_security_analyzer": 3.5,
    "idor_active_probe": 2.6,
    "email_header_injection_probe": 1.2,
    "file_upload_active_probe": 1.8,
    "xml_bomb_detector": 1.0,
    "tenant_isolation_check": 2.1,
    # Detection handlers (observation-based, moderate findings)
    "js_sink_source_analyzer": 1.8,
    "wasm_module_introspector": 0.7,
    "prototype_pollution_walker": 1.5,
    "dom_runtime_analyzer": 2.0,
    "waf_fingerprint_analyzer": 1.3,
    "waf_challenge_detector": 0.8,
    "csrf_entropy_analyzer": 1.6,
    "session_fixation_detector": 1.4,
    "rate_limit_adaptive_prober": 1.1,
    "race_concurrent_mutator": 1.3,
    "api_rest_param_pollution": 1.7,
    "api_graphql_introspection": 1.2,
    "api_rate_limit_differential": 1.0,
    "api_jwt_claim_integrity": 1.5,
    "api_websocket_message_security": 0.9,
    # Passive detectors (reliable pattern matching)
    "header_checker": 2.8,
    "cookie_security_checker": 2.1,
    "cors_misconfig_checker": 1.9,
    "cache_control_checker": 1.5,
    "jsonp_endpoint_checker": 1.1,
    "frontend_config_exposure_checker": 1.7,
    "directory_listing_checker": 0.8,
    "debug_artifact_checker": 1.2,
    "stored_xss_signal_detector": 1.6,
    "dom_xss_signal_detector": 1.4,
    ...
    "app_ssrf_scan": 1.4,
    "clickjacking_detector": 1.8,
    "csrf_protection_checker": 1.6,
    "graphql_introspection_detector": 1.1,
    "logging_security_detector": 0.9,
    "oauth_misconfiguration_detector": 2.0,
    "open_redirect_detector": 1.5,
    "sql_error_exposure_detector": 1.7,
    "ssti_surface_detector": 1.3,
    "file_upload_surface_detector": 1.0,
    "vulnerable_component_detector": 1.6,
    "xxe_surface_detector": 1.2,
    # JSON analysis
    "access_boundary_tracker": 1.4,
    "bulk_endpoint_detector": 0.8,
    "cross_tenant_pii_risk_analyzer": 1.9,
    "cross_user_access_simulation": 1.7,
    "endpoint_resource_groups": 0.6,
    "json_response_parser": 0.5,
    "json_schema_inference": 0.7,
    "nested_object_traversal": 1.0,
    "privilege_escalation_detector": 2.3,
    "response_structure_validator": 0.4,
    "role_based_endpoint_comparison": 1.2,
    "role_context_diff": 1.1,
    "sensitive_field_detector": 1.5,
    # Inline analyzers with known legacy implementations
    "sensitive_data_scanner": 2.4,
    "token_leak_detector": 1.8,
    "business_logic_tampering_detector": 1.6,
    "technology_fingerprint": 0.9,
    "response_snapshot_system": 0.3,
    "response_diff_engine": 1.4,
    "anomaly_detector": 0.7,
    "rate_limit_signal_analyzer": 1.1,
    "rate_limit_header_analyzer": 0.8,
    "response_size_anomaly_detector": 0.6,
    "payment_flow_intelligence": 1.0,
    "payment_provider_detection": 0.8,
    "behavior_analysis_layer": 1.3,
    "cognitive_flow_analysis": 2.1,
    "redirect_chain_analyzer": 0.7,
    "graphql_error_leakage_checker": 1.0,
    "openapi_swagger_spec_checker": 0.6,
    "grpc_reflection_exposure_checker": 0.5,
    "cloud_storage_exposure_checker": 1.2,
    "cloud_metadata_exposure_checker": 1.4,
    "subdomain_takeover_indicator_checker": 1.1,
    "service_worker_misconfiguration_checker": 0.4,
    "csp_weakness_analyzer": 1.3,
    "referrer_policy_weakness_checker": 0.9,
    "hsts_weakness_checker": 1.0,
    "dns_misconfiguration_signal_checker": 0.7,
    "email_leakage_detector": 0.8,
    "api_version_disclosure_checker": 0.5,
    "password_confirmation_checker": 0.6,
    "cache_poisoning_indicator_checker": 0.8,
    "error_stack_trace_detector": 1.1,
    "cdn_waf_fingerprint_gap_checker": 0.5,
    "public_repo_exposure_checker": 1.3,
    "backup_file_exposure_checker": 1.5,
    "environment_file_exposure_checker": 1.6,
    "log_file_exposure_checker": 1.2,
    ...
    "dns_record_analyzer": 0.9,
    "ldap_injection_surface_analyzer": 0.8,
    ...
    "token_scope_analyzer": 0.8,
    "referer_propagation_tracking": 0.7,
    "pagination_walker": 1.2,
    "filter_parameter_fuzzer": 1.5,
    "error_based_inference": 1.4,
    "state_transition_analyzer": 1.1,
    "parameter_dependency_tracker": 0.9,
    "flow_integrity_checker": 0.8,
    "flow_detector": 1.0,
    "race_condition_signal_analyzer": 1.2,
    "version_diffing": 0.5,
    "unauth_access_check": 1.6,
    "ssrf_candidate_finder": 0.8,
    "idor_candidate_finder": 0.9,
    "options_method_probe": 0.7,
    "origin_reflection_probe": 0.8,
    "head_method_probe": 0.4,
    "cors_preflight_probe": 0.9,
    "trace_method_probe": 0.5,
    "graphql_active_probe": 1.3,
    "graphql_introspection_check": 1.1,
    "http_smuggling_probe": 1.8,
    "http_smuggling_detector": 1.5,
    "http2_probe": 0.9,
    "oauth_flow_analyzer": 2.0,
