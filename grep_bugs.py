...
# Print results
order = [
    '1_json.loads', '2_json_load', '3_dict_get_default_list',
    '4_setdefault_empty_list', '4b_unassigned_list_comp',
    '5_next_gen_none', '6_filter_none', '7_sum', '8_max_min', '9_list_var',
]
