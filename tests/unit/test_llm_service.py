...
def test_fastapi_explain_route(
    tmp_path: Path, mock_finding, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_fastapi_triage_review_route(
    tmp_path: Path, mock_finding, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_fastapi_ai_summary_route(
    tmp_path: Path, mock_finding, monkeypatch: pytest.MonkeyPatch
) -> None:
